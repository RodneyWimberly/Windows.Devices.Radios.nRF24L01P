...
//        public RadioOld(GpioPin cePin, SpiDevice spiDevice)
//        {
//            _isAckPayloadAvailable = false;
...
//                receiveAddressPipe0Register.Load(Utilities.GetBytes(_receiveAddressPipe0.ToString("X")));
...
//        {
//            byte[] address = Utilities.GetBytes(value.ToString("X"));
...
//        {
//            byte[] buffer = Utilities.GetBytes(address.ToString("X"));
//            if (pipeId == 0)

...
namespace X10SerialSlave.Server
{
    ...
    public sealed class Rf24Server : IX10Controller
    {
        ...
        public void Initialize()
        {
            ...
            Debug.Write(_radio.Configuration.GetDetails());
            TestWriteAndRead();
        }
        ...
        {
            Debug.WriteLine(bytes.Aggregate(string.Empty, (current, bit) => current + bit.ToString("X")));
        ...
        public void WriteBytes([ReadOnlyArray] byte[] bytes)
        {
            ...
            if (_role == Roles.RolePingOut)
            {
                ...
                _radio.Write(BitConverter.GetBytes(time));
